...
`)
        ...
        if (answers.startScript || answers.callipygeScript || answers.nowScript || answers.sassScript || answers.dependency) {
          if (answers.startScript || answers.callipygeScript || answers.nowScript) {
            ...
            if (answers.sassScript) {
              appPkg.scripts.sass = 'node-sass --include-path node_modules/foundation-sites/scss'
            }
/*
#node_modules/.bin/node-sass --include-path node_modules/foundation-sites/scss mine/yo.scss
*/
          }
